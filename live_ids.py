...
if FLOW_ACTIVITY_TIMEOUT < 30:
    print(f"[Config] WARNING: FLOW_ACTIVITY_TIMEOUT={FLOW_ACTIVITY_TIMEOUT}s is very low. "
          f"Features may not match training distribution (trained at 120s). "
          f"Consider raising this value.")
